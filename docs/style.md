...
Every piece of prose in this repo follows this guide. It mirrors the
anti-slop writing skill from the maintainers' agent setup, which is
built on the GOV.UK style guide and GDS content design principles.
See AGENTS.md for how it is enforced.
